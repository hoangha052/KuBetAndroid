...
class MatchResultViewModel(private val repo: LeaguesRepository, private val id: String) : ViewModel() {
    ...
    fun init() {
        repo.getLeague(id).map { it.getHistories() }.subscribe({ matchesLiveData.value = it }, {})
    }
